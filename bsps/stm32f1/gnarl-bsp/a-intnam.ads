...
package Ada.Interrupts.Names is
   ...
   USB_HP_CAN_TX_Interrupt    : constant Interrupt_ID := 21;

   --  USB Low Priority or CAN RX0 interrupts
   USB_LP_CAN_RX0_Interrupt   : constant Interrupt_ID := 22;

   --  CAN RX1 interrupt
   CAN_RX1_Interrupt          : constant Interrupt_ID := 23;

   --  CAN SCE interrupt
   CAN_SCE_Interrupt          : constant Interrupt_ID := 24;
   ...
   TIM8_BRK_Interrupt         : constant Interrupt_ID := 45;

   --  TIM8 Update interrupt
   TIM8_UP_Interrupt          : constant Interrupt_ID := 46;

   --  TIM8 Trigger and Commutation interrupts
   TIM8_TRG_COM_Interrupt     : constant Interrupt_ID := 47;

   --  TIM8 Capture Compare interrupt
   TIM8_CC_Interrupt          : constant Interrupt_ID := 48;

   --  ADC3 global interrupt
   ADC3_Interrupt             : constant Interrupt_ID := 49;
   ...
   DMA2_Channel4_5_Interrupt  : constant Interrupt_ID := 61;

   --  FPU global interrupt
   FPU_Interrupt              : constant Interrupt_ID := 62;
