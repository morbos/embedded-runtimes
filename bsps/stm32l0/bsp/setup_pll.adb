...
procedure Setup_Pll is
   ...
   HSI48_Enabled   : constant Boolean := True;
   HSI16_Enabled   : constant Boolean := True;  -- use high-speed int. clock
   ...
   begin
      ...
      if HSI16_Enabled then
         RCC_Periph.CR.HSI16ON := True;
         loop
            exit when RCC_Periph.CR.HSI16RDYF;
         end loop;
      end if;
