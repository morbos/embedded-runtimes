...
package Interfaces.STM32.RCC is
   ...
   subtype APB1RSTR1_USART3RST_Field is Interfaces.Bit_Types.Bit;
   subtype APB1RSTR1_UART4RST_Field is Interfaces.Bit_Types.Bit;
   subtype APB1RSTR1_UART5RST_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1ENR1_SP3EN_Field is Interfaces.Bit_Types.Bit;
   subtype APB1ENR1_USART2EN_Field is Interfaces.Bit_Types.Bit;
   subtype APB1ENR1_USART3EN_Field is Interfaces.Bit_Types.Bit;
   ...
   type APB1ENR1_Register is record
      ...
      --  SPI3 clock enable
      SP3EN          : APB1ENR1_SP3EN_Field := 16#0#;
      --  unspecified
      Reserved_16_16 : Interfaces.Bit_Types.Bit := 16#0#;
      --  USART2 clock enable
   ...
   type AHB1SMENR_Register is record
      ...
      --  unspecified
      Reserved_12_15 : Interfaces.Bit_Types.UInt4 := 16#1#;
   ...
   subtype APB1SMENR1_USART3SMEN_Field is Interfaces.Bit_Types.Bit;
