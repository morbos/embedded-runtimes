...
package Ada.Interrupts.Names is
   ...
   --
   RES30_Interrupt               : constant Interrupt_ID := 30;
   ...
   --
   RES42_Interrupt               : constant Interrupt_ID := 42;

   --
   RES43_Interrupt               : constant Interrupt_ID := 43;

   --
   RES44_Interrupt               : constant Interrupt_ID := 44;

   --
   RES45_Interrupt               : constant Interrupt_ID := 45;

   --
   RES46_Interrupt               : constant Interrupt_ID := 46;

   --
   RES47_Interrupt               : constant Interrupt_ID := 47;

   --
   RES48_Interrupt               : constant Interrupt_ID := 48;

   --  SDMMC global Interrupt
   SDMMC1_Interrupt              : constant Interrupt_ID := 49;

   --
   RES50_Interrupt               : constant Interrupt_ID := 50;
   ...
   --
   RES53_Interrupt               : constant Interrupt_ID := 53;
   ...
   --
   RES63_Interrupt               : constant Interrupt_ID := 63;
   ...
   --
   RES75_Interrupt               : constant Interrupt_ID := 75;
