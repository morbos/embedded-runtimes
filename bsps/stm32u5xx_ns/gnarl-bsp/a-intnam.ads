...
--  This is a version for the STM32L5x2 MCU
package Ada.Interrupts.Names is
   ...
   TIM2_3_Interrupt         : constant Interrupt_ID := 46;

   --  TIM4 global interrupt
   TIM2_4_Interrupt         : constant Interrupt_ID := 47;

   --  TIM5 global interrupt
   TIM2_5_Interrupt         : constant Interrupt_ID := 48;
