...
package Interfaces.STM32.Flash is
   ...
   subtype ACR_LATENCY_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype NSCR_NSPNB_Field is Interfaces.Bit_Types.UInt7;
   ...
   subtype SECCR_SECPNB_Field is Interfaces.Bit_Types.UInt7;
   ...
   type SECCR_Register is record
      ...
      --  SECPNB
      SECPNB         : SECCR_SECPNB_Field := 16#0#;
      --  unspecified
      Reserved_10_10 : Interfaces.Bit_Types.Bit := 16#0#;
      --  SECBKER
   ...
   subtype NSBOOTADD0R_NSBOOTADD0_Field is Interfaces.Bit_Types.UInt25;
   ...
   type NSBOOTADD0R_Register is record
      ...
      NSBOOTADD0   : NSBOOTADD0R_NSBOOTADD0_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype NSBOOTADD1R_NSBOOTADD1_Field is Interfaces.Bit_Types.UInt25;
   ...
   type NSBOOTADD1R_Register is record
      ...
      NSBOOTADD1   : NSBOOTADD1R_NSBOOTADD1_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SECBOOTADD0R_SECBOOTADD0_Field is Interfaces.Bit_Types.UInt25;
   ...
   type SECBOOTADD0R_Register is record
      ...
      SECBOOTADD0  : SECBOOTADD0R_SECBOOTADD0_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SECWM1R1_SECWM1_PSTRT_Field is Interfaces.Bit_Types.UInt7;
   subtype SECWM1R1_SECWM1_PEND_Field is Interfaces.Bit_Types.UInt7;

   --  Flash bank 1 secure watermak1 register
   type SECWM1R1_Register is record
      --  SECWM1_PSTRT
      SECWM1_PSTRT   : SECWM1R1_SECWM1_PSTRT_Field := 16#0#;
      --  unspecified
      Reserved_7_15  : Interfaces.Bit_Types.UInt9 := 16#1FE#;
      --  SECWM1_PEND
      SECWM1_PEND    : SECWM1R1_SECWM1_PEND_Field := 16#0#;
      --  unspecified
   ...
   subtype SECWM1R2_PCROP1_PSTRT_Field is Interfaces.Bit_Types.UInt7;
   subtype SECWM1R2_HDP1_PEND_Field is Interfaces.Bit_Types.UInt7;

   --  Flash secure watermak1 register 2
   type SECWM1R2_Register is record
      --  PCROP1_PSTRT
      PCROP1_PSTRT   : SECWM1R2_PCROP1_PSTRT_Field := 16#0#;
      --  unspecified
      Reserved_7_14  : Interfaces.Bit_Types.Byte := 16#1E#;
      --  PCROP1EN
      PCROP1EN       : Boolean := False;
      --  HDP1_PEND
      HDP1_PEND      : SECWM1R2_HDP1_PEND_Field := 16#0#;
      --  unspecified
   ...
   subtype WRP1AR_WRP1A_PSTRT_Field is Interfaces.Bit_Types.UInt7;
   subtype WRP1AR_WRP1A_PEND_Field is Interfaces.Bit_Types.UInt7;

   --  Flash Bank 1 WRP area A address register
   type WRP1AR_Register is record
      --  WRP1A_PSTRT
      WRP1A_PSTRT    : WRP1AR_WRP1A_PSTRT_Field := 16#0#;
      --  unspecified
      Reserved_7_15  : Interfaces.Bit_Types.UInt9 := 16#1FE#;
      --  WRP1A_PEND
      WRP1A_PEND     : WRP1AR_WRP1A_PEND_Field := 16#0#;
      --  unspecified
      Reserved_23_31 : Interfaces.Bit_Types.UInt9 := 16#1FE#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype WRP1BR_WRP1B_PSTRT_Field is Interfaces.Bit_Types.UInt7;
   subtype WRP1BR_WRP1B_PEND_Field is Interfaces.Bit_Types.UInt7;

   --  Flash Bank 1 WRP area B address register
   type WRP1BR_Register is record
      --  WRP1B_PSTRT
      WRP1B_PSTRT    : WRP1BR_WRP1B_PSTRT_Field := 16#0#;
      --  unspecified
      Reserved_7_15  : Interfaces.Bit_Types.UInt9 := 16#1FE#;
      --  WRP1B_PEND
      WRP1B_PEND     : WRP1BR_WRP1B_PEND_Field := 16#0#;
      --  unspecified
      Reserved_23_31 : Interfaces.Bit_Types.UInt9 := 16#1FE#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype SECWM2R1_SECWM2_PSTRT_Field is Interfaces.Bit_Types.UInt7;
   subtype SECWM2R1_SECWM2_PEND_Field is Interfaces.Bit_Types.UInt7;

   --  Flash secure watermak2 register
   type SECWM2R1_Register is record
      --  SECWM2_PSTRT
      SECWM2_PSTRT   : SECWM2R1_SECWM2_PSTRT_Field := 16#0#;
      --  unspecified
      Reserved_7_15  : Interfaces.Bit_Types.UInt9 := 16#1FE#;
      --  SECWM2_PEND
      SECWM2_PEND    : SECWM2R1_SECWM2_PEND_Field := 16#0#;
      --  unspecified
      Reserved_23_31 : Interfaces.Bit_Types.UInt9 := 16#1FE#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype SECWM2R2_PCROP2_PSTRT_Field is Interfaces.Bit_Types.UInt7;
   subtype SECWM2R2_HDP2_PEND_Field is Interfaces.Bit_Types.UInt7;

   --  Flash secure watermak2 register2
   type SECWM2R2_Register is record
      --  PCROP2_PSTRT
      PCROP2_PSTRT   : SECWM2R2_PCROP2_PSTRT_Field := 16#0#;
      --  unspecified
      Reserved_7_14  : Interfaces.Bit_Types.Byte := 16#1E#;
      --  PCROP2EN
      PCROP2EN       : Boolean := False;
      --  HDP2_PEND
      HDP2_PEND      : SECWM2R2_HDP2_PEND_Field := 16#0#;
      --  unspecified
      Reserved_23_30 : Interfaces.Bit_Types.Byte := 16#1E#;
      --  HDP2EN
   ...
   subtype WRP2AR_WRP2A_PSTRT_Field is Interfaces.Bit_Types.UInt7;
   subtype WRP2AR_WRP2A_PEND_Field is Interfaces.Bit_Types.UInt7;

   --  Flash WPR2 area A address register
   type WRP2AR_Register is record
      --  WRP2A_PSTRT
      WRP2A_PSTRT    : WRP2AR_WRP2A_PSTRT_Field := 16#0#;
      --  unspecified
      Reserved_7_15  : Interfaces.Bit_Types.UInt9 := 16#1FE#;
      --  WRP2A_PEND
      WRP2A_PEND     : WRP2AR_WRP2A_PEND_Field := 16#0#;
      --  unspecified
      Reserved_23_31 : Interfaces.Bit_Types.UInt9 := 16#1FE#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype WRP2BR_WRP2B_PSTRT_Field is Interfaces.Bit_Types.UInt7;
   subtype WRP2BR_WRP2B_PEND_Field is Interfaces.Bit_Types.UInt7;

   --  Flash WPR2 area B address register
   type WRP2BR_Register is record
      --  WRP2B_PSTRT
      WRP2B_PSTRT    : WRP2BR_WRP2B_PSTRT_Field := 16#0#;
      --  unspecified
      Reserved_7_15  : Interfaces.Bit_Types.UInt9 := 16#1FE#;
      --  WRP2B_PEND
      WRP2B_PEND     : WRP2BR_WRP2B_PEND_Field := 16#0#;
      --  unspecified
      Reserved_23_31 : Interfaces.Bit_Types.UInt9 := 16#1FE#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type Flash_Peripheral is record
      ...
      NSKEYR       : aliased Interfaces.Bit_Types.Word;
      --  Flash secure key register
      SECKEYR      : aliased Interfaces.Bit_Types.Word;
      --  Flash option key register
      OPTKEYR      : aliased Interfaces.Bit_Types.Word;
      --  Flash low voltage key register
      LVEKEYR      : aliased Interfaces.Bit_Types.Word;
      --  Flash status register
      ...
      SECBB1R1     : aliased Interfaces.Bit_Types.Word;
      --  FLASH secure block based bank 1 register
      SECBB1R2     : aliased Interfaces.Bit_Types.Word;
      --  FLASH secure block based bank 1 register
      SECBB1R3     : aliased Interfaces.Bit_Types.Word;
      --  FLASH secure block based bank 1 register
      SECBB1R4     : aliased Interfaces.Bit_Types.Word;
      --  FLASH secure block based bank 2 register
      SECBB2R1     : aliased Interfaces.Bit_Types.Word;
      --  FLASH secure block based bank 2 register
      SECBB2R2     : aliased Interfaces.Bit_Types.Word;
      --  FLASH secure block based bank 2 register
      SECBB2R3     : aliased Interfaces.Bit_Types.Word;
      --  FLASH secure block based bank 2 register
      SECBB2R4     : aliased Interfaces.Bit_Types.Word;
      --  FLASH secure HDP control register
   ...
   SEC_FLASH_Periph : aliased Flash_Peripheral
     with Import, Address => System'To_Address (16#50022000#);
