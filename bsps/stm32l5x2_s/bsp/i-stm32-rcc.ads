...
package Interfaces.STM32.RCC is
   ...
   subtype PLLCFGR_PLLM_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype PLLSAI1CFGR_PLLSAI1SRC_Field is Interfaces.Bit_Types.UInt2;
   subtype PLLSAI1CFGR_PLLSAI1M_Field is Interfaces.Bit_Types.UInt4;
   ...
   type PLLSAI1CFGR_Register is record
      --  PLLSAI1SRC
      PLLSAI1SRC     : PLLSAI1CFGR_PLLSAI1SRC_Field := 16#0#;
      --  unspecified
      Reserved_2_3   : Interfaces.Bit_Types.UInt2 := 16#0#;
   ...
   subtype PLLSAI2CFGR_PLLSAI2SRC_Field is Interfaces.Bit_Types.UInt2;
   subtype PLLSAI2CFGR_PLLSAI2M_Field is Interfaces.Bit_Types.UInt4;
   subtype PLLSAI2CFGR_PLLSAI2N_Field is Interfaces.Bit_Types.UInt7;
   subtype PLLSAI2CFGR_PLLSAI2PDIV_Field is Interfaces.Bit_Types.UInt5;

   --  PLLSAI2 configuration register
   type PLLSAI2CFGR_Register is record
      --  PLLSAI2SRC
      PLLSAI2SRC     : PLLSAI2CFGR_PLLSAI2SRC_Field := 16#0#;
      --  unspecified
      Reserved_2_3   : Interfaces.Bit_Types.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_18_26 : Interfaces.Bit_Types.UInt9 := 16#0#;
   ...
   subtype CCIPR1_USART1SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_USART2SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_USART3SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_UART4SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_UART5SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_LPUART1SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_I2C1SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_I2C2SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_I2C3SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_LPTIM1SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_LPTIM2SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_LPTIM3SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_FDCANSEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_CLK48MSEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR1_ADCSEL_Field is Interfaces.Bit_Types.UInt2;

   --  CCIPR1
   type CCIPR1_Register is record
      --  USART1 clock source selection
      USART1SEL      : CCIPR1_USART1SEL_Field := 16#0#;
      --  USART2 clock source selection
      USART2SEL      : CCIPR1_USART2SEL_Field := 16#0#;
      --  USART3 clock source selection
      USART3SEL      : CCIPR1_USART3SEL_Field := 16#0#;
      --  UART4 clock source selection
      UART4SEL       : CCIPR1_UART4SEL_Field := 16#0#;
      --  UART5 clock source selection
      UART5SEL       : CCIPR1_UART5SEL_Field := 16#0#;
      --  LPUART1 clock source selection
      LPUART1SEL     : CCIPR1_LPUART1SEL_Field := 16#0#;
      --  I2C1 clock source selection
      I2C1SEL        : CCIPR1_I2C1SEL_Field := 16#0#;
      --  I2C2 clock source selection
      I2C2SEL        : CCIPR1_I2C2SEL_Field := 16#0#;
      --  I2C3 clock source selection
      I2C3SEL        : CCIPR1_I2C3SEL_Field := 16#0#;
      --  Low power timer 1 clock source selection
      LPTIM1SEL      : CCIPR1_LPTIM1SEL_Field := 16#0#;
      --  Low power timer 2 clock source selection
      LPTIM2SEL      : CCIPR1_LPTIM2SEL_Field := 16#0#;
      --  Low-power timer 3 clock source selection
      LPTIM3SEL      : CCIPR1_LPTIM3SEL_Field := 16#0#;
      --  FDCAN clock source selection
      FDCANSEL       : CCIPR1_FDCANSEL_Field := 16#0#;
      --  48 MHz clock source selection
      CLK48MSEL      : CCIPR1_CLK48MSEL_Field := 16#0#;
      --  ADCs clock source selection
      ADCSEL         : CCIPR1_ADCSEL_Field := 16#0#;
      --  unspecified
   ...
   subtype CCIPR2_I2C4SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR2_ADFSDMSEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR2_SAI1SEL_Field is Interfaces.Bit_Types.UInt3;
   subtype CCIPR2_SAI2SEL_Field is Interfaces.Bit_Types.UInt3;
   subtype CCIPR2_OSPISEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   type AHB1SECSR_Register is record
      ...
      TSCSECF        : Boolean;
      --  unspecified
      Reserved_17_21 : Interfaces.Bit_Types.UInt5;
      --  Read-only. GTZCSECF
      GTZCSECF       : Boolean;
   ...
   type AHB2SECSR_Register is record
      ...
      SRAM2SECF      : Boolean;
      --  unspecified
      Reserved_10_20 : Interfaces.Bit_Types.UInt11;
   ...
   type APB1SECSR1_Register is record
      ...
      TIM7SECF       : Boolean;
      --  unspecified
      Reserved_6_9   : Interfaces.Bit_Types.UInt4;
   ...
   type APB2SECSR_Register is record
      ...
      SYSCFGSECF     : Boolean;
      --  unspecified
      Reserved_1_10  : Interfaces.Bit_Types.UInt10;
      --  Read-only. TIM1SECF
      TIM1SECF       : Boolean;
      --  Read-only. SPI1SECF
      SPI1SECF       : Boolean;
   ...
   SEC_RCC_Periph : aliased RCC_Peripheral
     with Import, Address => System'To_Address (16#50021000#);
